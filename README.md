...
1. (Windows) Install STLink [Drivers](https://www.st.com/en/development-tools/stsw-link009.html). _Make a new account with ST before downloadning, their confirmation Email from this site never reaches for some reason._
